...
try {
    ...
    // Update admin profile using the updateDetails method from parent User class
    $result = $admin->updateDetails($user_id, $name, $contact_number, $address, $profile_image ? $profile_image : $adminData['profile_image']);
